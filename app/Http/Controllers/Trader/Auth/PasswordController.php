...
class PasswordController extends Controller
{
    ...
    */
    ...
    use ResetsPasswords;
    protected $linkRequestView = 'trader.auth.passwords.email';
    protected $resetView = 'trader.auth.passwords.reset';
    protected $redirectTo = 'trader';
    protected $guard = 'trader';
    protected $broker = 'traders';
    /**
    ...
    public function sendResetLinkEmailApi(Request $request)
    {
        ...
        switch ($response) {
            ...
            default:
                return $api->errorResponse(trans('api.user_not_found'));
        }
    }
}

        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Override Bid Amount</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                @include('admin.includes.status-msg')
                <form role="form" enctype="multipart/form-data" method="post" action="{{url('dealer/auctions/override_bid_amount/post/'.$auction->id)}}" onSubmit="if(!confirm('Are you sure you want to override bid amount this  Auction?')){return false;}">
                     {{ csrf_field() }}
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                            <label>Override Bid Price</label>

                       ...
                       <div class="col-xs-12">
                            <div class="col-xs-6 item">
                                <div class="form-group">
                                    ...
                                    <input type="file" multiple class="form-control" id="images" name="images[]" required accept="image/jpeg,image/gif,image/png,image/jpg">
                               </div>
                       ...
                       <div class="col-xs-12">
                           <div class="col-xs-6 item">
                                <div class="form-group">
                                    ...
                                    <input type="file" multiple class="form-control" id="attachment" name="attachment[]"  accept="image/jpeg,image/gif,image/png,image/jpg">
                               </div>

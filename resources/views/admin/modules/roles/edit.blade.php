    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="box box-danger">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br />
                    <form data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{ route('roles.update',$edit->id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="name" required="required" class="form-control col-md-7 col-xs-12"
                                        value=@if(isset($edit)) "{{$edit->label}}" @endif disabled>
                                </div>
                            </div>
                            <div class="panel ">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="panel panel-default" style="clear: both;">
                                        <div class="panel-body">
                                            ...
                                            <div class="col-md-3 permission-blocks">
                                                <input type="checkbox" name="permission[]" class="form-control minimal-red" value="{{ $k1 }}" @foreach($edit->permissions as $selected) @if($k1 == $selected->id) checked @endif @endforeach>
                                    ...
                                    @else
                                    <div class="col-md-3">
                                        {{ Form::checkbox('permission[]', $v, $edit->permissions,
                                        ['class'=>'checkboxRole minimal-red'] ) }}

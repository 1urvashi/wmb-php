    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="box box-primary">
                ...
                <form role="form" enctype="multipart/form-data" method="post" action="{{url('auctions/override_bid_amount/post/'.$auction->id)}}" onSubmit="if(!confirm('Are you sure you want to override bid amount this  Auction?')){return false;}">
                     {{ csrf_field() }}

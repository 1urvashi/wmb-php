            ...
            <tbody>
                ...
                <tr style="">
                    <td class="action-content" style="color: #00043C;background: #F1F1F1;padding: 20px 60px;padding-bottom: 60px;">
                       <h1 style="font-family:Verdana;font-weight: normal;font-size: 22px;margin-top: 26px;line-height: 100%;color: #00043C;text-align: center;line-height: 160%;"><br>Welcome to WatchMyBid<br /></h1>
                         ...
                         <p style="font-weight: normal;line-height: 150%;margin-bottom: 20px;margin-top: 50px;">
                            ...
                            This is a system generated mail for to inform you that your admin onboarder has been created with WatchMyBid.</p>
